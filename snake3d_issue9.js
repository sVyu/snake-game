// 3D Snake Game - Issue #9: Repair Main Game, Arrow/W/S, UX
...
const keyList = [
    ...
    { key: 'W/S', desc: 'Move y+1/y-1 (manual)' },
...
document.addEventListener('keydown', (e) => {
    ...
    // Arrow keys and W/S for manual movement
    if (!autoTracking && !paused) {
        if (e.key === 'ArrowLeft') velocity = new THREE.Vector3(-1, 0, 0);
        else if (e.key === 'ArrowRight') velocity = new THREE.Vector3(1, 0, 0);
        else if (e.key === 'ArrowUp' || e.key.toLowerCase() === 'w') velocity = new THREE.Vector3(0, 1, 0);
        else if (e.key === 'ArrowDown' || e.key.toLowerCase() === 's') velocity = new THREE.Vector3(0, -1, 0);
    }
});
